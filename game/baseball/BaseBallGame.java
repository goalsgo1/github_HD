...
//	ImageIcon 	titleIcon = new ImageIcon(imgPath+"yagu.png");
	...
	/*
	 * 배경 이미지 구현 class BgPanel extends JPanel{ public void paintComponent(Graphics
	 * g) { g.drawImage(bg.getImage(), 0,0,null); setOpaque(false);
	...
	public void initDisplay() {
		...
		// jtf_user.addActionListener(ehandler);//여기서 this는 자기자신 클래스를
		// 가리킴.-BaseBallGame:내안에 actionPerformed
